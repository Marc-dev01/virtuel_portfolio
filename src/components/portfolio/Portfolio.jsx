    ...
    <div class="vg-page page-portfolio" id="portfolio">
      <div class="container">
        ...
        <div class="gridder my-3">
          <div class="grid-item apps wow zoomIn" data-aos="zoom-in">
            <div
              class="img-place"
              data-src="img/work/work-1.jpg"
              data-fancybox
          ...
          <div
            class="grid-item template wireframes wow zoomIn"
            data-aos="zoom-in"
          >
            <div
              class="img-place"
          ...
          <div class="grid-item apps ios wow zoomIn" data-aos="zoom-in">
            <div
              class="img-place"
              data-src="img/work/work-3.jpg"
              data-fancybox
          ...
          <div class="grid-item graphic ui-ux wow zoomIn" data-aos="zoom-in">
            <div
              class="img-place"
              data-src="img/work/work-4.jpg"
              data-fancybox
          ...
          <div
            class="grid-item graphic ui-ux wireframes wow zoomIn"
            data-aos="zoom-in"
          >
            <div
              class="img-place"
              data-src="img/work/work-6.jpg"
              data-fancybox
